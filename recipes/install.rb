...
when "rhel"
  ...
  package ['pciutils', 'python3-pip', 'mlocate', 'gcc', 'gcc-c++', 'openssl', 'openssl-devel', 'python3', 'python3-devel', 'python3-lxml', 'python3-pillow', 'libcurl-devel', 'python3-wheel', 'python3-six']
end
